...
CastingMoreMenu.propTypes = {
  onDelete: PropTypes.func,
  userName: PropTypes.string
};

export default function CastingMoreMenu({ onDelete, userName }) {
  ...
  return (
    <>
      <IconButton ref={ref} onClick={() => setIsOpen(true)}>
        <Icon icon={moreVerticalFill} width={20} height={20} style={{transform: 'rotate(90deg)'}} />
      </IconButton>
